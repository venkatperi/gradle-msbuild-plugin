 ...
 * 
 * Things that produce reports (typically tasks) expose a report container that contains {@link org.gradle.api.reporting.Report} objects for each
 ...
 * be produced by way of its {@link org.gradle.api.reporting.Report#setEnabled(boolean) enabled} property.
 *
 * ReportContainer implementations are <b>immutable</b> in that standard collection methods such as {@code add()}, {@code remove()}
 * and {@code clear()} will throw an {@link org.gradle.api.reporting.ReportContainer.ImmutableViolationException}. However, implementations may provide new methods that allow
